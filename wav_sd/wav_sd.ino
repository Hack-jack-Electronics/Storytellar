//------------------------------------------------------------------------------------------------------------------------
// 
// Title: SD Card Wav Player with Speed Control
//
// Description:
//    Modified version with speed control options to slow down playback
//
//------------------------------------------------------------------------------------------------------------------------
...
void setup() {    
    ...
    WavFile = SD.open("/scene_2.wav");                   // Open the wav file
    if(WavFile==false)
      Serial.println("Could not open 'scene_2.wav'");
    else
    {
      ...
      {
        // Apply speed control based on selected method
        ...
        i2s_set_sample_rates(i2s_num, adjustedSampleRate);      //set sample rate 
      }
    }
}
