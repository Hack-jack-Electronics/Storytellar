...
// ----------- Firebase WAV URL ------------
const char* firebaseURL = "https://storage.googleapis.com/storyteller-7ece7.firebasestorage.app/intro-audio/4b48ee87-7c35-4afe-a0d2-f9ca24cc9ab7/intro_5_1756450393.wav";
...
String getFilenameFromURL(String url) {
  ...
  if (lastSlash >= 0) {
    return url.substring(lastSlash + 1); // returns the part after the last slash
  }
  return url;
}
...
void setup() {
  ...
  // Extract filename from URL and prepend '/' for SD path
  String filename = "/" + getFilenameFromURL(firebaseURL);
